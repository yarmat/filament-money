# This is my package filament-money
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/filament-money.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/filament-money)
...
```php
$filamentMoney = new Ymsoft\FilamentMoney();
echo $filamentMoney->echoPhrase('Hello, Ymsoft!');
```
